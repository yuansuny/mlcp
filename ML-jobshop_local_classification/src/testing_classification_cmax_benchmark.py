...
if __name__=='__main__':
    ...
    np.savetxt("../results_cmax/benchmark_{}_{}_{}_objs.csv".format(obj, ml_method, dataset), allobjs, delimiter=",")
    np.savetxt("../results_cmax/benchmark_{}_{}_{}_branches.csv".format(obj, ml_method, dataset), allbranches, delimiter=",")
    np.savetxt("../results_cmax/benchmark_{}_{}_{}_runtimes.csv".format(obj, ml_method, dataset), alltime, delimiter=",")
