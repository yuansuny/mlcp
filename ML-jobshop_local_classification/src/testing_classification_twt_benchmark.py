...
if __name__=='__main__':
    ...
    parser.add_argument('-ml_method', default="SVM", type=str, help='ML method')  # "SVM", "DT", "KNN", "MLP", "LR", "NONE"
    parser.add_argument('-level', default="local", type=str, help='ordering level')  # "global", "local"
    parser.add_argument('-time_limit', default=600, type=float, help='cutoff time of CP')
    ...
    np.savetxt("../results_twt/benchmark_{}_{}_objs.csv".format(obj, ml_method), allobjs, delimiter=",")
    np.savetxt("../results_twt/benchmark_{}_{}_branches.csv".format(obj, ml_method), allbranches, delimiter=",")
    np.savetxt("../results_twt/benchmark_{}_{}_runtimes.csv".format(obj, ml_method), alltime, delimiter=",")
