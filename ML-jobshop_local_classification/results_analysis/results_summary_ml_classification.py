...
if __name__=='__main__':
    ...
    # methods = ["NONE_global_regression", "GP_global_regression",  "GPc_local_classification", "LR_local_classification",
    ...
    # methods = ["NONE_global_regression", "GP_global_regression", "GPc_local_classification", "LR_local_classification"]
    # methodStr = ["Default", "BranGP", "ClasGP", "LR"]
    ...
    # methods = ["NONE_global_regression", "MIN_DOMAIN_SIZE_local_classification", "LOWEST_MIN_local_classification",
    #            "GP_global_regression", "GP_pure_classification", "GPc_local_classification", "GPc_pure_classification",
    #             "SVM_pure_classification"]
    # methodStr = ["Default", "MinDom", "LowMin", "BranGP", "BranGP_p", "ClasGP", "ClasGP_p", "SVM_p"]


    # methods = ["NONE_global_regression", "MIN_DOMAIN_SIZE_local_classification", "LOWEST_MIN_local_classification",
    #            "GP_pure_classification", "GPc_pure_classification","SVM_pure_classification"]
    # methodStr = ["Default", "MinDom", "LowMin",  "BranGP_p", "ClasGP_p", "SVM_p"]
    ...
    # methods = ["NONE_global_regression", "MIN_DOMAIN_SIZE_local_classification", "LOWEST_MIN_local_classification",
    #            "GP_pure_classification", "GPc_pure_classification", "SVM_pure_classification", "MLP_global_regression"]
    # methodStr = ["Default", "MinDom", "LowMin", "BranGP", "GP-C", "SVM-C", "MLP-R"]
    ...
    # methods = ["NONE_global_regression", "MIN_DOMAIN_SIZE_local_classification", "LOWEST_MIN_local_classification",
    #            "GP_global_regression", "GPc_local_classification"]
    # methodStr = ["Default", "MinDom", "LowMin", "BranGP-H", "ClasGP-H"]


    # methods = ["NONE_global_regression", "GP_pure_classification", "GP_global_regression", "GPc_pure_classification", "GPc_local_classification"]
    # methodStr = ["Default", "BranGP",  "BranGP-H", "ClasGP", "ClasGP-H"]

    methods = ["NONE_global_regression", "GPc_pure_classification", "GPc_local_classification", "MLP_100_pure_classification",
               "MLP_100_local_classification", "SVM_pure_classification", "SVM_local_classification"]
    methodStr = ["Default", "GP-C", "GP-H", "MLP-C", "MLP-H", "SVM-C", "SVM-H"]
    ...
    ax.legend(loc='lower left', fontsize=19.5, ncol=3)
    plt.xlabel('Instance Size', fontsize=20)
    plt.ylabel('Improvement', fontsize=20)
    plt.xticks(fontsize=15)
    plt.yticks(fontsize=15)

    filename = 'figs/hybrid_' + obj + '_imp.png'
    # filename = 'figs/ml_' + obj + '_imp.png'
    ...
    val1 = df.Improvement[df.Method == methodStr[4]]
    for j in range(1, len(methods)):
