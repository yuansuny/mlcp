...
if __name__=='__main__':
    ...
    # methods = ["NONE_local_classification", "GP_local_classification", "GPc_local_classification", "SVM_local_classification"]
    ...
    for instance in instances:
        for ml_method in methods:
            ...
            df_branches = np.genfromtxt("../results_ini/{}_{}_{}_nm_{}_nj_{}_branches.csv".format(obj, h, ml_method, instance, instance),delimiter=",")
    ...
    filename = 'figs/ml_ini_' + obj + '_imp.png'
    ...
    print(table)
    np.savetxt("results_summary/ml_ini_{}_table.csv".format(obj), table, delimiter=",", fmt='%s')
