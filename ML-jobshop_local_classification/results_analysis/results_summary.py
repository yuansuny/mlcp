...
if __name__=='__main__':
    ...
    ml_methods = ["NONE_global_regression", "GP_local_classification", "GPc_local_classification", "LR_local_classification"]
    # ml_methods = ["NONE_global_regression", "GP_local_classification", "LR_local_classification"]
    ...
    # target_names = ["NONE", "GP", "SVM", "OLS", "DT", "KNN", "MLP"]

    target_names = ["NONE", "GP", "GPc", "LR"]
    # target_names = ["NONE", "GP", "LR"]
    ...
    plt.ylabel("reduction in number of branches %", fontsize=30)
    filename = 'figs/' + obj + '_' + scale + '_branch.png'
