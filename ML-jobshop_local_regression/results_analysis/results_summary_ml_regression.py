...
if __name__=='__main__':
    ...
    methods = ["NONE_global_regression", "GP_global_regression", "Optimal_global_regression", "GPr_global_regression",
               "SVM_global_regression", "OLS_global_regression", "DT_global_regression", "MLP_global_regression"]
    methodStr = ["Default", "BranGP", "OptStart", "RegrGP", "SVM", "OLS", "DT", "MLP"]

    # methods = ["NONE_global_regression", "GP_global_regression", "Optimal_global_regression",
    #            "SVM_global_regression", "OLS_global_regression", "DT_global_regression", "KNN_global_regression", "MLP_global_regression"]
    # methodStr = ["Default", "BranGP", "OptStart",  "SVM", "OLS", "DT", "KNN", "MLP"]

    # methods = ["NONE_global_regression", "GP_global_regression", "Optimal_global_regression",
    #            "SVM_global_regression", "OLS_global_regression", "DT_global_regression", "MLP_128_global_regression"]
    # methodStr = ["Default", "BranGP", "OptStart", "SVM", "OLS", "DT", "MLP"]

    # methods = ["NONE_global_regression", "GP_global_regression", "Optimal_global_regression", "MLP_global_regression", "MLP_128_global_regression",
    #            "MLP_256_global_regression", "MLP_512_global_regression", "MLP_1024_global_regression", "MLP_2048_global_regression"]
    # methodStr = ["Default", "BranGP", "OptStart", "MLP", "MLP_128", "MLP_256", "MLP_512", "MLP_1024", "MLP_2048"]
